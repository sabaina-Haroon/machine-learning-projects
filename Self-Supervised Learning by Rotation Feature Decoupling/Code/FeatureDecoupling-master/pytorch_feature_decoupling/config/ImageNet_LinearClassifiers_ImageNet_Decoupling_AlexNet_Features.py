...
config['max_num_epochs'] = 65


networks = {}

#pretrained = '../_experiments/ImageNet_Decoupling_AlexNet/feature_net_epoch245'
pretrained = '../_experiments/ImageNet_Decoupling_AlexNet/feature_net_epoch_exp2200'
...
# net_opt_cls[2] = {'pool_type':'max', 'nChannels':384, 'pool_size':5, 'num_classes': 1000}
...
net_opt_cls[1] = {'pool_type':'max', 'nChannels':192, 'pool_size':7, 'num_classes': 200}
net_opt_cls[2] = {'pool_type':'max', 'nChannels':384, 'pool_size':5, 'num_classes': 200}
net_opt_cls[3] = {'pool_type':'max', 'nChannels':256, 'pool_size':6, 'num_classes': 200}
net_opt_cls[4] = {'pool_type':'max', 'nChannels':256, 'pool_size':6, 'num_classes': 200}
